...
// poolServer.validateShares: the pool checks the shares itself (own share difficulty per miner), see poolValidating.js
if (config.poolServer.validateShares) {
	module.exports = require('./poolValidating.js');
	return;
}
